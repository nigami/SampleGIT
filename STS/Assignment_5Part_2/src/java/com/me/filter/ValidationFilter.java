...
public class ValidationFilter implements Filter {
    ...
    public void doFilter(ServletRequest request, ServletResponse response,
        ...
        try {
            ...
            String[] isbn = (String[])req.getParameterValues("isbn");
            String[] bookTitle = (String[])req.getParameterValues("bookTitle");
            String[] author = (String[])req.getParameterValues("author");
            ...
            {
                isbn[i]=isbn[i].replaceAll("[^\\dA-Za-z]", "").trim();
                bookTitle[i]=bookTitle[i].replaceAll("[^\\dA-Za-z]", "").trim();
                author[i]=author[i].replaceAll("[^\\dA-Za-z]", "").trim();
                price[i]=price[i].replaceAll("[^\\dA-Za-z]", "").trim();
